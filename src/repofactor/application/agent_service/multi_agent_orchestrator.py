...
class MultiAgentOrchestrator:
    ...
    async def run_full_flow(self, repo_content_old, repo_content_new, instructions):
...
async def example_run():
    ...
    new_repo = {"main.py": "print('Hello World!')"}
    instructions = "Modernize code output"
    results = await orchestrator.run_full_flow(old_repo, new_repo, instructions)
    print(results)
